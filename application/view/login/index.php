<div class="container">
    ...
    <form method="POST" action="<?php echo URL; ?>Login/validar" autocomplete="off" onsubmit="return validarlogin()">
       <input type="text" name="mail" id="mail" placeholder="Usuario" />
         <input type="password" name="pasadmin" id="pasadmin" placeholder="Contraseña" />

          <center><div class="footer"><button type="submit" class="btn btn-primary"  name="submit">Iniciar sesión</button></div></center>
...
if (isset($_SESSION['rar'])) {
  echo $_SESSION['rar'];
  unset($_SESSION['rar']);
}else if (isset($_SESSION['rr'])) {
  echo $_SESSION['rr'];
  unset($_SESSION['rr']);
}
