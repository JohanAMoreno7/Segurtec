          ...
          <div class="form-group row">
            ...
            <div class="form-group row">
             ...
             <div class="form-group row">
              ...
              <div class="col-md-1">
                <input type="text" class="form-control input-sm input" name="codigor" id="codigor" value="4001" readonly>
              </div>
             ...
             <div class="form-group row">
              ...
              <div class="col-md-2">
                <input type="text" class="form-control input-sm input" name="description" id="description" value="Monitores y sensores" readonly>
              </div>
